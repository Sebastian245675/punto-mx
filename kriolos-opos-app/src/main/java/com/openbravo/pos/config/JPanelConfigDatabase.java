...
// secondary DB        
    ...
    private void initComponents() {
        ...
        // Cargar icono de base de datos de forma segura
        try {
            java.net.URL dbIconUrl = getClass().getResource("/com/openbravo/images/database.png");
            if (dbIconUrl != null) {
                jButtonTest.setIcon(new javax.swing.ImageIcon(dbIconUrl));
            }
        } catch (Exception e) {
        ...
        try {
            java.net.URL dbIconUrl = getClass().getResource("/com/openbravo/images/database.png");
            if (dbIconUrl != null) {
                jButtonTest1.setIcon(new javax.swing.ImageIcon(dbIconUrl));
            }
        } catch (Exception e) {
            // Si no se puede cargar, continuar sin icono
        }
