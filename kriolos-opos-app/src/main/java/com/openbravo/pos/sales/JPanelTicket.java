...
public abstract class JPanelTicket extends JPanel implements JPanelView, TicketsEditor {
    ...
    public void activate() throws BasicException {
        ...
        // Actualizar el template Printer.Ticket2 en la base de datos desde el archivo
        // XML
    ...
    private void printTicket(String sresourcename, TicketInfo ticket, String ticketext) {
        ...
        try {
            ...
            fw.write("{\"id\":\"log_" + System.currentTimeMillis() + "_resource\",\"timestamp\":"
                    + System.currentTimeMillis()
                    + ",\"location\":\"JPanelTicket.java:2706\",\"message\":\"Resource loaded from DB\",\"data\":{\"resource\":\""
                    ...
                    + ",\"displayIndex\":" + displayIndex + ",\"ticketFirst\":" + ticketFirst
                    + "},\"sessionId\":\"debug-session\",\"runId\":\"run1\",\"hypothesisId\":\"B\"}\n");
            fw.close();
            System.out.println("DEBUG: Resource " + sresourcename + " loaded from DB, ticketFirst=" + ticketFirst
                    + ", ticketIndex=" + ticketIndex + ", displayIndex=" + displayIndex);
        } catch (IOException ex) {
    ...
    private void initComponents() {
        ...
        btnVarios.addActionListener(e -> {
            javax.swing.JOptionPane.showMessageDialog(this, "Función Varios", "Varios",
