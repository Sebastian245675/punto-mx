 ...
 * different from the rest of the classes listed previously in that it is more
 * like a pluggable component than a utility class. It can be used in
 * Swing-based applications to view the reports generated by the JasperReports
 * library. This visual component was included like a demo component to show how
 * the core printing functionality can be used to display the reports in
 * Swing-based applications. The preferred way to adapt this component to a
 * particular application is by subclassing it.
 *
...
public final class JRViewer400 extends javax.swing.JPanel implements JRHyperlinkListener {
    ...
    /**
     * Maximum size (in pixels) of a buffered image that would be used to render
     * a report page. If rendering a report page would require an image larger
     * than this threshold (i.e. image width x image height greater maximum
     * size), the report page will be rendered directly on the viewer component.
    ...
    /**
     * @see #JRViewer400(JasperReportsContext, String, boolean, Locale,
     * ResourceBundle)
     */
    ...
    /**
     * @see #JRViewer400(JasperReportsContext, InputStream, boolean, Locale,
     * ResourceBundle)
     */
    ...
    /**
     * @see #JRViewer400(JasperReportsContext, JasperPrint, Locale,
     * ResourceBundle)
     */
